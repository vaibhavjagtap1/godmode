  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      ...
      <form className="space-y-3 rounded border border-slate-700 bg-panel p-4">
        <input className="w-full border border-slate-600 bg-transparent p-2" placeholder="Name" type="text" />
        ...
        <button className="w-full border border-accent bg-accent/10 p-2 text-accent" type="submit">Sign up</button>
      </form>
    </div>
  );
}
